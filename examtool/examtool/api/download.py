...
def get_question_to_page_mapping(
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        with open(temp_file, "rb") as fp:
            ...
            for page in tqdm(pages, desc="Extracting questions", unit="Page", total=num_pages):
                ...
                for lobj in layout:
                    if isinstance(lobj, LTTextBox):
                        ...
                        if text == "STUDENT LEFT QUESTION BLANK\n":
                            ...
                            y0 = round(((page.mediabox[3] - y1_orig) / layout.y1) * 100, 1)
                            y1 = round(((page.mediabox[3] - y0_orig) / layout.y1) * 100, 1)
