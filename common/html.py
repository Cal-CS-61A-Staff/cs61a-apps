...
def html(out):
    ...
    if "<h1" not in out:
        if hasattr(current_app, "remote"):
            ...
            out = f'<h1 class="mt-5">61A {header}</h1>' + out
    return f"""
<html><head><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-+0n0xVW2eSR5OomGNYDnhzAbDsOXxcvSN1TPprVMTNDbiYZCxYbOOl7+AMvyTG2x" crossorigin="anonymous"></head><body>
<div class="container">
{out}
</div>
